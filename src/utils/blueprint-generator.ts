...
<body>
  ...
  <div style="background: #0f0f0f; border: 1px solid #252525; padding: 16px; margin-bottom: 40px; font-family: 'Fragment Mono', monospace; font-size: 11px; display: flex; justify-content: space-between; align-items: center;">
    ...
    <div style="text-align: right;">
      ...
      <a href="https://github.com/understory-ip/autonomaton-primitive/blob/master/src/config/prompts.schema.ts" target="_blank" style="color: #4CAF72; text-decoration: none; border-bottom: 1px dotted #4CAF72;">v1.0 (View Source)</a><br/>
      <span style="color: #D4621A; font-size: 14px; font-weight: bold;">
        PIPELINE HASH: <a href="https://github.com/understory-ip/autonomaton-primitive" target="_blank" style="color: #D4621A; text-decoration: none;">#${escapeHtml(pipelineSignature)}</a>
      </span>
    </div>
  </div>
